  ...
  return (
    ...
    >
      <div style={{ maxWidth: "1240px", margin: "0 auto", padding: "28px 18px 80px" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "16px", flexWrap: "wrap", marginBottom: "24px" }}>
          <div>
            ...
            <p style={{ margin: "12px 0 0", color: "#d9e5ff", fontSize: "17px", lineHeight: 1.7, maxWidth: "920px" }}>
              This page shows the drivers already marked as added to policy. It gives the broker a clear separate queue without touching the homepage.
            </p>
          </div>
        ...
        >
          <div style={{ fontSize: "12px", fontWeight: 800, letterSpacing: "0.16em", textTransform: "uppercase", color: "#dfffee", marginBottom: "10px" }}>
            Queue summary
          </div>
          ...
          <div style={{ color: "#e6f6ff", lineHeight: 1.8 }}>
            As the broker marks drivers added to policy on the review page, they appear here automatically.
          </div>
        </section>
          ...
          <section style={{ display: "grid", gap: "16px" }}>
            {addedDrivers.map((driver) => (
              ...
              >
                ...
                >
                  <strong>Broker notes:</strong> {driver.notes || "No notes saved yet."}
                </div>
              </div>
            ))}
          </section>
