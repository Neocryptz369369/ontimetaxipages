...
export default function AdminDriversPage() {
  ...
  function renderDriverCard(d: any) {
  ...
  return (
    <div style={wrap}>
      <div style={shell}>
        ...
        <h2 style={{ fontSize: '20px', marginTop: '28px' }}>New drivers awaiting approval ({pendingDrivers.length})</h2>
        {pendingDrivers.length === 0 && <p style={{ color: '#9c8080' }}>No new applications right now.</p>}
        {pendingDrivers.map(renderDriverCard)}

        <h2 style={{ fontSize: '20px', marginTop: '28px' }}>All drivers ({drivers.length})</h2>
